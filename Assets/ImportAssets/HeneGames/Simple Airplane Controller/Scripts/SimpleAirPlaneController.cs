...
[RequireComponent(typeof(Rigidbody))]
    public class SimpleAirPlaneController : MonoBehaviour
    {
        ...
        {
            var _mutiplierXRot = sidewaysMovement * sidewaysMovementXRot;
            var _mutiplierYRot = sidewaysMovement * sidewaysMovementYRot;
            var _mutiplierYPos = sidewaysMovement * sidewaysMovementYPos;
